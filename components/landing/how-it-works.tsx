...
export async function HowItWorks() {
  const { totalMatches, cities, cityNames } = await getChapterStats();
  ...
  const steps = [
    {
      number: "01",
      title: "Hack",
      subtitle: `${cities} Cities. ${totalMatches} Hackathons.`,
      description: `${cityList}. The league travels across Europe. At each stop, teams compete in 24-48h hackathons hosted by top universities and tech communities.`,
      icon: (
