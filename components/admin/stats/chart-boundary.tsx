 ...
 *
 * Recharts' ResponsiveContainer can throw when it measures a 0/-1-sized parent
 * (seen during the ssr:false dynamic mount on some browsers/timings). Without a
 * boundary, that throw bubbled up and blanked the ENTIRE admin dashboard content
 * area. This keeps a chart failure local: the rest of the dashboard renders, and
 * the broken chart shows a small fallback instead of taking the page down.
 *
