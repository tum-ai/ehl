...
export default async function ParticipantDashboard() {
  ...
  // The personal certificate prints the profile name; without one the route has
  // nothing to certify (404), so don't offer the link.
  const hasProfileName = !!session.profile?.name;
